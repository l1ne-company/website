...
const L1NE_CAPABILITIES = [
  {
    ...
    status: "active",
    description: "AWS, GCP, Azure, On-Prem unified operations",
    project: "l1ne" as const,
  },
  {
    id: "CAP-002",
    capability: "Cryptographic Integrity Proofs",
    status: "active",
    description: "Verify infrastructure consistency across deployments",
    project: "l1ne" as const,
  },
  {
    id: "CAP-003",
    capability: "Configuration Drift Detection",
    status: "active",
    description: "Automated discovery and remediation of drift",
    project: "l1ne" as const,
  },
  {
    id: "CAP-004",
    ...
    status: "active",
    description: "Instant state reversion across cloud regions",
    project: "l1ne" as const,
  },
  {
    id: "CAP-005",
    ...
    status: "active",
    description: "QUIC + gRPC secure channels end-to-end",
    project: "l1ne" as const,
  },
  {
    id: "CAP-006",
    capability: "Distributed Artifact Cache",
    status: "active",
    description: "S3-compatible, multi-region cache",
    project: "l1ne" as const,
  },
  {
    id: "CAP-007",
    capability: "Declarative Infrastructure",
    status: "active",
    description: "GitOps-native, immutable deployments",
    project: "l1ne" as const,
  },
  {
    id: "CAP-008",
    capability: "Observability & Audit Logs",
    status: "active",
    description: "Complete audit trail of all infrastructure changes",
    project: "l1ne" as const,
  },
];
